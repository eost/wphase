...
WPINV_TS     = BIN+'wpinversion -nt -imas ts_i_master -ifil o_wpinversion -ofil ts_o_wpinversion -ocmtf ts_WCMTSOLUTION '+\
...
WPINV_XY     = BIN+'wpinversion -nt -imas xy_i_master -ifil xy_o_wpinversion -ofil xy_o_wpinversion -ocmtf xy_WCMTSOLUTION '+\
                   '-ps xy_p_wpinversion -wpbm xy_wpinv.pgm -log LOG/_xy_wpinversion.log -osyndir xy_SYNTH -pdata xy_fort.15'

WPINV_DP     = BIN+'wpinversion -nt -imas dp_i_master -ifil dp_o_wpinversion -ofil dp_o_wpinversion '+\
