...
WPINV_TS     = BIN+'wpinversion_LTZ -imas ts_i_master -ifil o_wpinversion -ofil ts_o_wpinversion -ocmtf ts_WCMTSOLUTION -ps ts_p_wpinversion '+\
...
WPINV_XY     = BIN+'wpinversion_LTZ -imas xy_i_master -ifil xy_o_wpinversion -ofil xy_o_wpinversion -ocmtf xy_WCMTSOLUTION -ps xy_p_wpinversion '+\
